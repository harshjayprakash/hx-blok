 ...
 *          2 for 'self does not contain an instance of grid'.
*/
 ...
 * @returns 0 for 'success', 
 *          1 for 'map variable not allocated', 
 *          2 for 'self does not contain an instance of grid', 
 *          3 for 'grid reached array limit',
 *          4 for 'could not find available index'.
*/
 ...
 * @return The index of the point specified. OR 
 *         -1 for 'map variable not allocated', 
 *         -2 for 'self does not contain an instance of grid',
 *         -3 for 'index not found'.
*/
int Grid_FindMark(Grid* self, int x, int y);

/**
 * Finds the next empty index available in the map array.
 * @return The index of a point that the has not got a coordinates. OR 
 *         -1 for 'map variable not allocated',
 *         -2 for 'self does not contain an instance of grid',
 *         -3 for 'no available index found'.
*/
