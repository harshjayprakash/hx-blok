...
/**
 * @brief Stores all of the globals that will need to be accessible throughout the program.
 */
struct program
{
    /**
     * @brief Stores the instance handle of the program. This is what Windows uses to find the
     * executable in memory.
     */
    HINSTANCE instance_handle;

    /**
     * @brief Stores the previous version of the instance handle of the program. This is for 16-bit
     * programs. This is not used.
     */
    HINSTANCE previous_instance_handle;

    /**
     * @brief Stores the command line arguments specified on startup of the program.
     */
    LPSTR command_line_arguments;

    /**
     * @brief Stores how the program's user interface should be shown to the user.
     */
    int show_flag;
};

/**
 * @brief Responsible for initialising and allocating any memory required for the program's globals.
 ...
 */
void program_init(HINSTANCE _instance_handle, HINSTANCE _previous_instance_handle,
