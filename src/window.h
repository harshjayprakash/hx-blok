 ...
 * @returns
 *      0 for 'success',
 *      1 for 'self does not contain an instance of the window structure',
 *      2 for 'app does not contain an instance of the application structure',
 *      3 for 'failed to register window',
 *      4 for 'failed to create window'.
*/
 ...
 * @returns
 *      Result of the RegisterClassEx Macro method. OR
 *      -1 for 'self does not contain an instance of the window structure',
 *      -2 for 'window class has already been registered'.
*/
 ...
 * @returns
 *      0 for 'success',
 *      1 for 'failed to create window',
 *      -1 for 'self does not contain an instance of the window structure',
 *      -2 for 'the window has already been registered',
 *      -3 for 'the window class has not been registered'.
*/
 ...
 *      0 for 'success',
 *      -1 for 'self does not contain an instance of the window structure',
 *      -2 for 'the window has not been created',
 *      -3 for 'the window class has not been registered',
 *      -4 for 'the window is already visible'.
*/
 ...
 *      -1 for 'self does not contain an instance of the window structure',
 *      -2 for 'the window has not been created',
 *      -3 fof 'the window class has not been registered'.
*/
